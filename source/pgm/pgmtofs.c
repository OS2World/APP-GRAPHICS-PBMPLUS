...
int cols, rows, bps;
    ...
    fprintf (stdout,  "Telephone: \n" );
    fprintf (stdout,  "Company: \n" );
    fprintf (stdout,  "Address1: \n" );
    fprintf (stdout,  "Address2: \n" );
    fprintf (stdout,  "CityStateZip: \n" );
    fprintf (stdout,  "Date: \n" );
    fprintf (stdout,  "PicData: %d %d %d\n", cols, rows, bps );
    fprintf (stdout,  "Image: %d %d %d\n", cols, rows, bps );
    fprintf (stdout,  "\n" );
