...
main( argc, argv )
    ...
    fprintf (stdout, "\033P0;1;0;4;1;%d;%d;1!R1/", rows, rucols);
...
nextrow: fprintf (stdout, "%d/", nout+1);		/* Total bytes to transfer = nout+1 */
        fflush(stdout);
